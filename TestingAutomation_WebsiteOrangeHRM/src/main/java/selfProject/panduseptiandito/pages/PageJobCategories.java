...
public class PageJobCategories {

    private WebDriverWait wait;

    public PageJobCategories(WebDriver driver){
...
//    MAIN DASH
    ...
    WebElement btnAddJobCategories;
    @FindBy(xpath = "//div[@id='oxd-toaster_1']/div/div/div[2]/p[2]")
    WebElement popUpSucces;

    public void clickAddJobCategories(){
        waitTableJobCategories();
        wait.until(ExpectedConditions.visibilityOf(btnAddJobCategories));
        btnAddJobCategories.click();
        Delay(TWO);
    }
    public void actionEditJobCategories(WebDriver driver, String categories){
    ...
    public void actionDeleteJobCategories(WebDriver driver, String categories){
        String xpath = String.format(
    ...
    WebElement lblErrJobCategories;

    public void clearfldJobCategory(){
        wait.until(ExpectedConditions.visibilityOf(fldJobCategory));
        fldJobCategory.click();
    ...
    public void fillJobCategory(String category){
        wait.until(ExpectedConditions.visibilityOf(fldJobCategory));
        fldJobCategory.click();
        Actions actions = new Actions(driver);
        actions.
                ...
                .keyUp(Keys.CONTROL)
                .sendKeys(Keys.BACK_SPACE).perform();
        fldJobCategory.sendKeys(category);
        Delay(TWO);
    }
...
//    SHOW ELEMENTS
    ...
    public void waitTableJobCategories(){
...
//    VALIDATION
    ...
    public String getVerifyEmptyField(){
        waitFormAdd();
        String validation = lblErrJobCategories.getText();
        return validation;
    }
...
//        return Validation;
    ...
    public String getVerifyDataInField(){
        waitFormEdit();
        wait.until(ExpectedConditions.visibilityOf(fldJobCategory));
        String validasi = fldJobCategory.getAttribute("value");
        return validasi;
    }
